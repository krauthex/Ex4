...
\begin{itemize}
	\item sehr dünner Anodendraht  $\lp \approx \mu m \rp$ 
	...
	\item Reicht aus um Gas zu ionisieren $\rightarrow$ Sekundärelektronen\\
...
\bsp{%
	...
	Ideale Detektorlänge: $20 \lambda \rightarrow 112 \si{mm}$ Blei
	
	Abwechselnd: $2 \si{mm}$ Blei und  $5 \si{mm}$ Szintillationszähler
	
	$\rightarrow 392 \si{mm}$ Länge (elektromagnetisches Kalorimeter, ECAL)\\

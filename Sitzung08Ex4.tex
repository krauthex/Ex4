...
\end{equation}
wobei $L$ die Luminosität des Beschleunigers ist. Dies ist schematisch in Abb. \ref{streuung} dargestellt.
...
\begin{align}
	...
	\intertext{Mit trigonometrischen Identitäten folgt:}
	%% next equation
...
\begin{equation}
	\Omega := \mathop{\int}_{\varphi_1}^{\varphi_2} \kern -0.2em \mathop{\int}_{\vartheta_1}^{\vartheta_2} \sin \vartheta^\prime \md \vartheta^\prime \md \varphi^\prime
\end{equation}

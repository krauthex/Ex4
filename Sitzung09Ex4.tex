...
\begin{figure}[H]
\begin{tabular}{lcl}
Name & Beschreibung & Formel \\
Rutherford & \begin{tabular}{cc} Projektil & $^{ \text{punktförmig}}_{\text{spinlos}}$ \\ Target & $^{ \text{punktförmig}}_{\text{spinlos}}$ \\ \end{tabular}  & $\frac{d\sigma^R}{d\Omega} = (zZe^2)^2 \cdot \left(\frac{1}{16 \ E_{kin}^2 \sin^4(\nicefrac{\theta}{2})} \  \text{oder} \ \frac{4 m_{Proj}^2}{q^4} \  \text{oder} \  \underbrace{\frac{4E_{end}^2}{(qc)^4}}_{relativist.}\right)$ \\ 
Mott & \begin{tabular}{cc} Projektil & $^{ \text{punktförmig}}_{\text{mit Spin}}$ \\ Target & $^{ \text{punktförmig}}_{\text{spinlos}}$ \\ \end{tabular}  & $\frac{d\sigma^M}{d\Omega} = (zZe^2)^2 \cdot \frac{4 E_{end}^2}{(qc)^4} \cdot  \underbrace{(1-\beta^2 sin^2\left(\nicefrac{\theta}{2}\right))}_{\text{fuer} \  v \approx c \  \text{ungefaehr} \  cos^2(\frac{\theta}{2})}$
\\ 
Dirac & \begin{tabular}{cc} Projektil & $^{ \text{punktförmig}}_{\text{mit Spin}}$ \\ Target & $^{ \text{punktförmig}}_{\text{mit Spin}}$ \\ \end{tabular}  & $\frac{d\sigma^D}{d\Omega} = (zZe^2)^2 \cdot \frac{4 E_{end}^2}{(qc)^4} \cdot \left(1-\beta^2 \underbrace{\frac{(qc)^2}{2 E_T}}_{=2 M_T^2 c^4}  tan^2(\nicefrac{\theta}{2})\right)$\\
Final & \begin{tabular}{cc} Projektil & $^{ \text{punktförmig}}_{\text{mit Spin}}$ \\ Target & $^{ \text{ausgedehnt}}_{\text{mit Spin}}$ \\ \end{tabular}  & $\frac{d\sigma}{d\Omega} = (zZe^2)^2 \cdot \frac{4 E_{end}^2}{(qc)^4}^2 \cdot \left( \frac{G_E^2 - \left(\nicefrac{qc}{2E_T}\right)^2 G_M^2}{1- \left(\nicefrac{qc}{2E_T}\right)^2} - \beta^2 \left(\frac{qc}{2E_T}\right)^2 G_M^2 tan^2(\nicefrac{\theta}{2})\right)$
\\ 
$^{\text{Rosenbluth}}_{\text{Plot-Formel}}$ & & $\frac{d\sigma}{d\Omega}= a \  (G_E^2 - b \  G_M^2) - d \  G_M^2 tan^2(\nicefrac{\theta}{2})$\\
\end{tabular}
\end{figure}
\textbf{Legende:} 
\begin{itemize} 
